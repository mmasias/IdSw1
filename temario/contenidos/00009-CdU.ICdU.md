# Casos de Uso > Prototipar casos de uso
...
|Detalle|Proyecto|
|-|-|
[abrirEdificios](https://github.com/mmasias/pySigHor/tree/main/RUP/00-casos-uso/02-detalle/abrirEdificios#pantalla-1-gesti%C3%B3n-de-edificios)|[SigHor](https://github.com/mmasias/pySigHor)
[abrirAulas](https://github.com/mmasias/pySigHor/blob/main/RUP/00-casos-uso/02-detalle/abrirAulas/README.md#prototipos-de-interfaz): ¡No solo pantallas!|
[descenderPieza](https://github.com/mmasias/pyTetris/blob/main/docs/ProcesoRequisitos.md#prototipar-casos-de-uso)|[Tetris](https://github.com/mmasias/pyTetris)
[listarGrupos](https://github.com/TheMoys/24-25-IdSw1-SDR/blob/main/docs/casosDeUso/prototipos/README.md#listar-grupos)|[DocuTrace](https://github.com/TheMoys/24-25-IdSw1-SDR)

</div>

### Acerca del prototipado

- [Dintel](https://dintel.redsara.es/inicio.html), sistema de Diseño de la Agencia Estatal de Administración Digital (AEAD). Su objetivo es ayudar a quienes diseñan y desarrollan servicios electrónicos, promoviendo un lenguaje común y colaborativo.
- 
